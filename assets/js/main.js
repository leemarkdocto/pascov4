...
function openCart() {
  document.getElementById("cart-main-nav").style.width = "100%";
}
function closeCart() {
  document.getElementById("cart-main-nav").style.width = "0";
}
...
function isotope(){
	...
	//Mobile Isotope Sorting
	var $mobileIsotope = $('#mobileIsotope');

	$mobileIsotope.isotope({})

	$('#mobileSelectFilter').change( function() {
		$mobileIsotope.isotope({
			filter: this.value
		});
	});
